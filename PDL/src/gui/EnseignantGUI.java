...
public class EnseignantGUI {
    ...
    private void initialize() {
    	  /**
         * Création de la fenêtre d'accueil de l'enseignant
         */
        frame = new JFrame();
       ...
       /**
        * Création de la fenêtre de la liste des cours de l'enseignant
        */
        ...
        /**
         * Création de la fenêtre Planning de l'enseignant
         */
         ...
         /**
          * Création de la fenêtre Faire l'appel de l'enseignant
          */
        ...
        /**
         * Création du bouton pour accéder à liste des cours de l'enseignant
         */
	    ...
	    /**
	     * Création du bouton pour accéder au planning de l'enseignant
	     */
	    ...
	    /**
	     * Création du bouton pour accéder à la liste d'absence de l'enseignant
	     */
