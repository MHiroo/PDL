	...
	private void initialize() {
		...
		btnAbsent.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// Obtenir la date du jour en utilisant java.util.Date
				Date dateDuJour = new Date();
				// Convertir la date du jour en java.sql.Date
				java.sql.Date sqlDateDuJour = new java.sql.Date(dateDuJour.getTime());
				Absence absence = new Absence(idEtudiant, idCours ,heureDebut, nbHeure,sqlDateDuJour,"En verification" );
